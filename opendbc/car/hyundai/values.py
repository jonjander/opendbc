...
class CAR(Platforms):
  ...
  KIA_XCEED_PHEV_2021 = HyundaiPlatformConfig(
    [HyundaiCarDocs("Kia XCeed PHEV 2021", car_parts=CarParts.common([CarHarness.hyundai_b]))],
    CarSpecs(mass=1600, wheelbase=2.65, steerRatio=13.75, tireStiffnessFactor=0.5),
    flags=HyundaiFlags.HYBRID,
  )
...
FW_QUERY_CONFIG = FwQueryConfig(
  ...
  non_essential_ecus={
    Ecu.abs: [CAR.HYUNDAI_PALISADE, CAR.HYUNDAI_SONATA, CAR.HYUNDAI_SANTA_FE_2022, CAR.KIA_K5_2021, CAR.HYUNDAI_ELANTRA_2021,
              ...
              CAR.KIA_CEED, CAR.KIA_XCEED_PHEV_2021, CAR.KIA_SELTOS],
  },
  extra_ecus=[
